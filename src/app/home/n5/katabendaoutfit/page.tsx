...
import { NounOutfitN5 } from '@/features/home/types/materin5';

const NounOutfitPage = () => {
  const [nounOutfit, setNounOutfit] = useState<NounOutfitN5[]>([]);
  ...
  const progressPercentage =
    nounOutfit.length > 0 ? (completedCount / nounOutfit.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Outfit N5</h1>
          </div>
        ...
        {!loading && !error && nounOutfit.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-white/60 text-lg">
              Belum ada materi kata Outfit N5 tersedia
            </p>
          </div>
        )}
      </section>
