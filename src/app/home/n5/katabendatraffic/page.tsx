...
import { NounTrafficN5 } from '@/features/home/types/materin5';

const NounTrafficPage = () => {
  const [nounTraffic, setNounTraffic] = useState<NounTrafficN5[]>([]);
...
const handleNounTrafficClick = async (
  ...
  const progressPercentage =
    nounTraffic.length > 0 ? (completedCount / nounTraffic.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Traffic N5</h1>
          </div>
        ...
        {!loading && !error && nounTraffic.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-white/60 text-lg">
              Belum ada materi kata traffic N5 tersedia
            </p>
          </div>
        )}
      </section>
