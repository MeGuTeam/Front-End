      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          ...
          <div className="border-l border-white/40">
            <p className="text-white/70 text-lg pl-2">
              Kamu bisa mulai dengan memilih salah satu materi yang tersedia di
              bawah.
            </p>
          </div>
        </motion.div>
      ...
      <section className="container mx-auto px-4 pt-8">
        {daftarMateriN5.map((data) => (
          <div key={data.id} className="py-8">
            <p className="text-2xl font-semibold border-l-4 border-white pl-2">
              {data.kategori}
            </p>
