...
import { NounRegionN5 } from '@/features/home/types/materin5';

const NounRegionPage = () => {
  const [nounRegion, setNounRegion] = useState<NounRegionN5[]>([]);
  ...
  const progressPercentage =
    nounRegion.length > 0 ? (completedCount / nounRegion.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Wilayah N5</h1>
          </div>
        ...
        {!loading && !error && nounRegion.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-white/60 text-lg">
              Belum ada materi kata Wilayah N5 tersedia
            </p>
          </div>
        )}
      </section>
