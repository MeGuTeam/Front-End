        ...
        <div className="bg-black min-h-svh text-white pt-18">
          ...
          <section className="container mx-auto px-4 pt-8">
            ...
            >
              ...
              <p className="text-white/70 text-lg">Pelajari kanji level N5 untuk menguasai bahasa Jepang</p>
            </motion.div>
          </section>
            ...
            >
              ...
              <div className='flex gap-2 items-center mb-4'>
                ...
                <div className='flex gap-1 text-sm'>
                  ...
                  <span className="text-white/50">&gt;</span> 
                  <span className='text-blue-400 font-medium hover:cursor-pointer'>Kanji N5</span>
                </div>
              </div>
          ...
          <section className='container px-4 mx-auto mt-8 pb-8'>
                        ...
                        <div className='grid grid-cols-1 gap-3 mb-4'>
                          {data.onyomi && (
                            <div className='bg-white/5 rounded-lg p-3'>
                              ...
                              <p className="text-sm font-semibold text-white">{data.onyomi}</p>
                            </div>
                          )}
                          ...
                          {data.kunyomi && (
                            <div className='bg-white/5 rounded-lg p-3'>
                              ...
                              <p className="text-sm font-semibold text-white">{data.kunyomi}</p>
                            </div>
                          )}
                        </div>
            ...
            {!loading && !error && kanjiN5.length === 0 && (
              <div className="text-center py-20">
                ...
                <p className="text-white/60 text-lg">Belum ada materi kanji N5 tersedia</p>
              </div>
            )}
          </section>
        </div>
