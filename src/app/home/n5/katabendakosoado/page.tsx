...
import { NounKosoadoN5 } from '@/features/home/types/materin5';

const NounKosoadoPage = () => {
  const [nounKosoado, setNounKosoado] = useState<NounKosoadoN5[]>([]);
  ...
  const progressPercentage =
    nounKosoado.length > 0 ? (completedCount / nounKosoado.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Kosoado N5</h1>
          </div>
        ...
        >
          ...
          <div className="flex gap-2 items-center mb-4">
            ...
            <div className="flex gap-1 text-sm">
              <div className="hover:text-blue400 cursor-pointer transition-colors">
                <button
...
export default NounKosoadoPage;
