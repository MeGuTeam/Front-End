...
import { NounMediaN5 } from '@/features/home/types/materin5';

const NounMediaPage = () => {
  const [nounMedia, setNounMedia] = useState<NounMediaN5[]>([]);
...
const handleNounMediaClick = async (
  ...
  const progressPercentage =
    nounMedia.length > 0 ? (completedCount / nounMedia.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Media N5</h1>
          </div>
        ...
        >
          ...
          <div className="flex gap-2 items-center mb-4">
            ...
            <div className="flex gap-1 text-sm">
              ...
              <span className="text-white/50">&gt;</span>
              <span className="text-blue-400 font-medium">Kata Media N5</span>
            </div>
          </div>
