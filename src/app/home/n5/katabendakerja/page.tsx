...
import { NounWorkN5 } from '@/features/home/types/materin5';

const NounWorkPage = () => {
  const [nounWork, setNounWork] = useState<NounWorkN5[]>([]);
...
const handleNounWorkClick = async (
  ...
  const progressPercentage =
    nounWork.length > 0 ? (completedCount / nounWork.length) * 100 : 0;
