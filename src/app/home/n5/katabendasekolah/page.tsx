...
import { NounSchoolN5 } from '@/features/home/types/materin5';

const NounSchoolPage = () => {
  const [nounSchool, setNounSchool] = useState<NounSchoolN5[]>([]);
  ...
  const progressPercentage =
    nounSchool.length > 0 ? (completedCount / nounSchool.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Sekolah N5</h1>
          </div>
        ...
        {!loading && !error && nounSchool.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-white/60 text-lg">
              Belum ada materi kata Sekolah N5 tersedia
            </p>
          </div>
        )}
      </section>
