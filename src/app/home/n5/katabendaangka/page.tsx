...
import { NounNumberN5 } from '@/features/home/types/materin5';

const NounNumberPage = () => {
  const [nounNumber, setNounNumber] = useState<NounNumberN5[]>([]);
...
const handleNounNumberClick = async (
  ...
  const progressPercentage =
    nounNumber.length > 0 ? (completedCount / nounNumber.length) * 100 : 0;
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-3xl font-bold">Kata Angka N5</h1>
          </div>
        ...
        >
          ...
          <div className="flex gap-2 items-center mb-4">
            ...
            <div className="flex gap-1 text-sm">
              ...
              <span className="text-white/50">&gt;</span>
              <span className="text-blue-400 font-medium">Kata Angka N5</span>
            </div>
          </div>
        ...
        {!loading && !error && nounNumber.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-white/60 text-lg">
              Belum ada materi kata angka N5 tersedia
            </p>
          </div>
        )}
      </section>
