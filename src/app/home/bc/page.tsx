...
const BasicConversationPages = () => {
  ...
  const progressPercentage =
    conversations.length > 0
      ? (completedCount / conversations.length) * 100
      : 0;
  ...
  return (
    <div className="bg-black min-h-svh text-white pt-18">
      ...
      <section className="container mx-auto px-4 pt-8">
        ...
        >
          <h1 className="text-3xl font-bold mb-2">Percakapan Dasar</h1>
          <p className="text-white/70 text-lg">
            Pelajari percakapan dasar bahasa Jepang untuk kehidupan sehari-hari
          </p>
        </motion.div>
      </section>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex gap-2 mb-3">
                        <span
                          className={`inline-flex items-center gap-1 rounded-full text-xs px-3 py-1 font-medium ${
                            data.type === 'greeting'
        ...
        {!loading && !error && conversations.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-white/60 text-lg">
              Belum ada materi percakapan dasar tersedia
            </p>
          </div>
        )}
      </section>
