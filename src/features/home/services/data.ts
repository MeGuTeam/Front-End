...
export async function getParticle(
  ...
  try {
    ...
    console.error(
      'Pengambilan data dari fungsi getParticle pada services gagal - ',
      e
    );
  }
}
...
export const getHiragana = async (
  ...
  try {
    ...
    console.error(
      'Pengambilan data dari fungsi getHiragana pada services gagal - ',
      e
    );
  }
};
...
export const getKatakana = async (
  ...
  try {
    ...
    console.error(
      'Pengambilan data dari fungsi getKatakana pada services gagal - ',
      e
    );
  }
};

export const getBasicConversation = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
    ...
    console.error(
      'Pengambilan data dari fungsi getBasicConversation pada services gagal - ',
      e
    );
  }
};
...
export const getAdjectiveN5 = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getAdverbN5 = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getConjunctionN5 = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getQuestionWord = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounActivityN5 = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounAnimalAndPlant = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounAuxNumber = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounBody = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounCity = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounColor = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounFoodAndDrink = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounHomeAppliances = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounKosoado = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounMedia = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounNatural = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounNumber = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounOutfit = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounPeople = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounPosition = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounRegion = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounSchool = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounTime = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounTraffic = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
...
export const getNounWork = async (
  setterUpdatedData: React.Dispatch<React.SetStateAction<boolean>>
) => {
  try {
